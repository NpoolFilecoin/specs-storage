...
type Storage interface {
	...
	AddPiece(ctx context.Context, sector SectorRef, pieceSizes []abi.UnpaddedPieceSize, newPieceSize abi.UnpaddedPieceSize, pieceData Data, snapDeal bool) (abi.PieceInfo, error)
}
